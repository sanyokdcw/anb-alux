...
<body>
        ...
        <div class="container">
            <div class="inner_container">
                ...
                <nav class="nav">
                    ...
                    <div class="nav_link" style="cursor:pointer" onclick="scrollDCW('.section_services')">
                        {{  __('content.services')  }}</div>
                    <div class="nav_link" style="cursor:pointer" onclick="scrollDCW('.buyings')">
                        {{  __('content.procurement')  }}</div>
                    <div class="nav_link" style="cursor:pointer" onclick="scrollDCW('.news')">
    ...
    <header class="mobile-header">
        ...
        <div class="mobile-nav" id="menu">
            <div class="mobile-nav-link" style="cursor:pointer" onclick="scrollDCW('.ab_us_section')">
            ...
            <div class="mobile-nav-link" style="cursor:pointer" onclick="scrollDCW('.section_services')">
                {{  __('content.services')  }}</div>
            <div class="mobile-nav-link" style="cursor:pointer" onclick="scrollDCW('.buyings')">
                {{  __('content.procurement')  }}</div>
            <div class="mobile-nav-link" style="cursor:pointer" onclick="scrollDCW('.news')">
                {{  __('content.articles')  }}</div>
            <div class="mobile-nav-link" style="cursor:pointer" onclick="scrollDCW('.news')">{{  __('content.paper')  }}
            </div>
    ...
    align-items: center;flex-direction:column">
                ...
                <div class="lang dropdown" style="margin: 10px 0">
                    @if(session('locale') != 'kz')
                    <span>
                        Ru
                        <img src="/assets/arrow.png" alt="">
        ...
        <div class="intro__wrapper container">
            <div class="intro_inner" style="width:100%">
                ...
                <div class="intro_text" style="font-size: 28px">
                    <span>ИНВЕСТИЦИЯ </span>, КОНСАЛТИНГ, <br> САТУ ЖӘНЕ ДИСТРИБУЦИЯ <br> ӘЛЕМІНДЕГІ СIЗДІҢ <br> СЕНІМДІ
                    СЕРІКТЕСІҢІЗ
                </div>
                @endif
        ...
        <div class="block_wrap container">
            ...
            <div class="block buy_block">
                ...
                <div class="buy_about_wrap">
                    <a class="buy_about" href="#">{{  __('content.button')  }}<img src="assets/arrow_right.png"
                            alt=""></a>
                </div>
            </div>
            @endforeach
        ...
        <div class="news_wrap container">
            ...
            <div class="news_item">
                <div class="news_item_wrapper">
                    ...
                    <div class="news_inner_title" style="font-weight: bold;     min-height: 112px;">
                        {{$article->tile}}
                ...
                <div class="news__btn-wrap">
                    <a href="#" class="ab_button shine"
                        style="margin-top:0; padding: 16px 32px">{{  __('content.buttons')  }}</a>
                </div>
            </div>
            @endforeach
        </div>
  ...
  behavior: 'smooth'
                    ...
                    <div class="footer_link_item" style="cursor:pointer" onclick="document.querySelector('.section_services').scrollIntoView({
  behavior: 'smooth'
});">{{  __('content.services')  }}</div>
  ...
  behavior: 'smooth'
    ...
    <script>
var animData = {
    wrapper: document.getElementById('map_anb'),
    renderer: 'svg',
    loop: false,
    autoplay: true,
    path: 'js/map.json'
